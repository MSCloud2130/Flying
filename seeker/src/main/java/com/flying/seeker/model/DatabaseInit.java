...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Client c4 = new Client("Juan Carlos", 45, "emai4l@gmail.com", "img.com", "=3dad!23w", "token");
        clientRepository.insert(c1);
        clientRepository.insert(c2);
        clientRepository.insert(c3);
        clientRepository.insert(c4);

        Seller s1 = new Seller("David Suarez", 52, "300-558-4785", "www.social2.com", "email5@hotmail.com", "password",
                "token", "img.com");
        Seller s2 = new Seller("Manuel Munoz", 40, "300-258-7894", "www.social3.com", "email6@hotmail.com", "password",
                "token", "img.com");
        Seller s3 = new Seller("Sara Martinez", 25, "302-236-5874", "www.social4.com", "email7@hotmail.com", "password",
                "token", "img.com");
        ...
        Product p1 = new Product("EcoAdventure", "Avion", "Hotel", "Comida vegetariana", 500000.00, date.from(instant),
        ...
        Product p4 = new Product("EcoParque", "Avion", "CABAÑA", "Comida tropical", 400000.00, date.from(instant),
        ...
        Product p7 = new Product("EcoDinner", "Avion", "Hotel", "Comida vegetariana", 500000.00, date.from(instant),
